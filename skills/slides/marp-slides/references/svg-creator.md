...
- **viewBox 比率**: 縦2:横5 で固定する（例: `viewBox="0 0 1000 400"`）。同じ比率であれば `1200 0 0 480` のようにスケールしてもよい。スライドの横長フォーマットに合わせるための既定値であり、崩さない。
- **保存先**: `./svg/`。
...
- **余白**: 図の要素を viewBox の端に接触させない。`0 0 1000 400` なら上下左右に 40〜60px 程度の余白を確保する。
